            ...
            'tools' => [
                ...
                'child' => [
                    'uploads_all' => [
                        ...
                        'url' => 'uploads',
                        'description' => 'uploads.menu.list.description',
                        'route' => 'mconsole.uploads.index',
                        'visible' => true,
                        'enabled' => true,
                    ],
                    'uploads_form' => [
                        'name' => 'Create upload',
                        'translation' => 'uploads.menu.create.name',
                        'url' => 'uploads/create',
                        'description' => 'uploads.menu.create.description',
                        'route' => 'mconsole.uploads.create',
                        'visible' => false,
                        'enabled' => true,
                    ],
                    'uploads_update' => [
                        'name' => 'Edit uploads',
                        'translation' => 'uploads.menu.update.name',
                        'description' => 'uploads.menu.update.description',
                        'route' => 'mconsole.uploads.edit',
                        'visible' => false,
                        'enabled' => true,
                    ],
                    'uploads_delete' => [
                        'name' => 'Delete uploads',
                        'translation' => 'uploads.menu.delete.name',
                        'description' => 'uploads.menu.delete.description',
                        'route' => 'mconsole.uploads.destroy',
                        'visible' => false,
                        'enabled' => true,
                    ],
                    'presets_all' => [
